    ...
    if cmd_args.alignment_column == 0:
        ...
        for in_line in infile:
            ...
            if line_number == index:
                ...
                fatal_error(
                    "Index file out of sort order at index:",
                    index,
                    "input line:",
                    line_number,
                )
        ...
        if index_line:
            ...
            if start < 0:
                fatal_error(
                    "Alignment file specifies negative line number at:",
                    index_line.strip(),
                )
            ...
            while line_number == end:
                ...
                if index_line:
                    ...
                    if start < line_number:
                        fatal_error(
                            "Alignment file out of order at:", index_line.strip()
                        )
                else:
                    break
        ...
        if index_line:
            fatal_error(
                "Out of input before end of alignment index file at:",
                index_line.strip(),
            )
